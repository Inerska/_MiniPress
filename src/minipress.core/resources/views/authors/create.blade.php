...
@section('content')
    <h1 class="text-3xl font-semibold mb-5">Créer un auteur</h1>
    <form method="POST" action="/auteurs/create" class="w-full max-w-sm">
        <div class="md:flex md:items-center mb-6">
            ...
            <div class="md:w-2/3">
                <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="username" type="text" name="username">
            </div>
        </div>
        <div class="md:flex md:items-center mb-6">
            <div class="md:w-1/3">
